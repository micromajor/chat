// Liste des pays francophones européens et maghrébins
export const FRANCOPHONE_COUNTRIES = [
  { code: "FR", name: "France", flag: "🇫🇷", hasDepartments: true },
  { code: "BE", name: "Belgique", flag: "🇧🇪", hasDepartments: false },
  { code: "CH", name: "Suisse", flag: "🇨🇭", hasDepartments: false },
  { code: "LU", name: "Luxembourg", flag: "🇱🇺", hasDepartments: false },
  { code: "MC", name: "Monaco", flag: "🇲🇨", hasDepartments: false },
  { code: "MA", name: "Maroc", flag: "🇲🇦", hasDepartments: false },
  { code: "DZ", name: "Algérie", flag: "🇩🇿", hasDepartments: false },
  { code: "TN", name: "Tunisie", flag: "🇹🇳", hasDepartments: false },
] as const;
...
// Fonction pour afficher la localisation complète
export function getLocationLabel(country?: string | null, department?: string | null): string {
  ...
  if (country === "FR" && department) {
    // Import dynamique évité - on utilise le format direct
...
// Départements français intégrés ici pour éviter les imports circulaires
